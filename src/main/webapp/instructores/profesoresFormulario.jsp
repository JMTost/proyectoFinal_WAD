            ...
            <div class="card">
                ...
                <div class="card-body">
                    <c:if test="${modificar==1}">
                        <form method="post" action="InstructorServlet?accion=almacenarInstructor&modificar=1">
                            <fieldset>
                    ...
                    <c:if test="${modificar == 0}">
                        <form method="post" action="InstructorServlet?accion=almacenarInstructor&modificar=0">
                            <fieldset>
                                <legend>Información del instructor</legend>
                                <div class="mb-3">
                                    <label class="form-label">Nombre</label>
