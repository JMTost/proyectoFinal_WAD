                ...
                <div class="card-body">
                    <c:if test="${modificar==1}">
                        <form method="post" action="AdminServlet?accion=guardarAdmin&modificar=1">
                            <fieldset>
                                <legend>Infomración de administradores</legend>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="txtPassAdmin" id="txtPassAdmin" placeholder="Contraseña del administrador" value="<c:out value="${admin.entidad.passAdmin}"/>" class="form-control" required="required" minlength="5" />
                                </div>
                        ...
                        <form method="post" action="AdminServlet?accion=guardarAdmin&modificar=0">
                            <fieldset>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="txtPassAdmin" id="txtPassAdmin" placeholder="Contraseña de administrador" class="form-control" required="required" minlength="5" />
                                </div>
